...
public class Alumne {
    ...
    public boolean setNotesConvocatoria(int codiAssignatura,int convocatoria,double nota) {
        ExpedientDAO expedientDAO = new ExpedientDAO();
        return expedientDAO.canviarNota(this.dni,codiAssignatura,convocatoria,nota);
