...
public class Controller {
    ...
    public LoteriaPremi loteria=new LoteriaPremi();
    ...
    public void comprovar(){
        ...
        if (error){
            ...
            if (loteria.isEncertat()){
                caja1.setText(caja1.getText()+". NOM SORT ENCERTAT");
            }
            ...
            r61.setText(String.valueOf(loteria.getE()));
